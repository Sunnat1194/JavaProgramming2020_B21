...
public class StringMethod3 {
    public static void main(String[] args) {
        String sentence = "Java is fun is cool";
        sentence.replace("Java", "Paython");  // Python is fun Python is cool
       ...
       email = email.replace("gmail", "yahoo");
        ...
        String essay = "Bach 20  is cool, Batch 20 is the best , Batch 20 students are awesome";
        ...
        String r = "Cat is friendly, Cat is cutie";
